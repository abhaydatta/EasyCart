...
import com.GroceerCart.sa.listener.OtpListener
import java.util.*

class OtpEditTextView: LinearLayout, View.OnFocusChangeListener, TextWatcher, View.OnKeyListener {
    ...
    private fun init(context: Context) {
        ...
        for (i in 0 until fieldCount) {
            ...
            field.setPadding(getPX(5f), getPX(5f), getPX(5f), getPX(5f))
    ...
    companion object {
        ...
        private val TAG = OtpEditTextView::class.java.simpleName
    }
}
